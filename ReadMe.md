...
| :-------- |:------- | :------------------------- |
| `Counter`|React, Vite, HTML, CSS, JavaScript, Tailwind CSS, | **GitHub**. [ReactJS link](https://github.com/pittyh6/counterApp/tree/main/counterApp-reactjs) / [React Native link- In progress]() |
